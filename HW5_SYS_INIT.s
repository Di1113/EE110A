...
; GPIO, GPT1, GPT2 and GPT3 modules. 
;
; FUNCTION INDEX: 
;     InitSystemPower   -  turn on power for GPIO in PRCM 
;     InitSystemClock   -  turn on clock for GPIO, GPT1, GPT2 and GPT3 in PRCM
;
; REVISION HISTORY:
;     01/11/20  Di Hu      Initial Revision, separated out from main. 
...
; InitSystemClock
;
; Description:       This function turns on GPIO, GPT1, GPT2 and GPT3's clock
;                    in PRCM.  
;
...
EnableGPTnClock:                  ;enable clock for GPT0 for run and all modes
    ...
    ORR R0, R0, #GPTCLKGR_SETNS_GPT3   ; GPT3 in PRCM.GPTCLKGR
